                    ...
                    <div class="card-body">
                        ...
                        <div class="row checkout-form">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" class="form-control" value="{{ Auth::user()->phone }}" name="number" placeholder="Enter Mobile Number">
                            </div>
                            <div class="col-md-6 mt-3">
                            ...
                            <div class="col-md-6 mt-3">
                                <label for="firstname">Postel Code</label>
                                <input type="text" class="form-control" value="{{ Auth::user()->pincode }}" name="pincode" placeholder="Enter Postel Code">
                            </div>
                        </div>
                    </div>
                </div>
